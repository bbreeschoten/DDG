...
Refinery::Core.configure do |config|
  ...
  # Site name
  config.site_name = "Dagbestedings Gids"
  ...
  # config.dragonfly_secret = "1073e515ef99ce18d1ba3231fefdb51399b075ad8a994918"

  # Add extra tags to the wymeditor whitelist e.g. = {'tag' => {'attributes' => {'1' => 'href'}}} or just {'tag' => {}}
  config.wymeditor_whitelist_tags = {'ul' => {'attributes' => {'data-orbit' => 'data-orbit'}}}
